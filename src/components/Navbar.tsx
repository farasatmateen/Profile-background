  ...
  return (
    <div>
        <nav className='w-full h-20 fixed md:h-16 text-white bg-black flex justify-between items-right text-right '>
            <div className='ml-5 md:ml-10 text-xl md:5xl lg:text-5xl font-times new roman text-green-500'>SAMEED MATEEN</div>
            <div className='flex flex-row text-xl mr-10 lg:mr-20 font-semibold'>
                ...
                <div className='hidden md:block md:mx-[20px] lg:mx-[35px] cursor-pointer '>Chemical products</div>
                <div className='hidden md:block md:mx-[20px] lg:mx-[35px] cursor-pointer '>Order</div>
